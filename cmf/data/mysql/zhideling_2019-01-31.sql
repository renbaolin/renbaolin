...
# Database: zhideling
# Generation Time: 2019-01-31 10:44:47 +0000
# ************************************************************
...
# Dump of table zdl_admin_menu
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_admin_menu`;
...
LOCK TABLES `zdl_admin_menu` WRITE;
/*!40000 ALTER TABLE `zdl_admin_menu` DISABLE KEYS */;

INSERT INTO `zdl_admin_menu` (`id`, `parent_id`, `type`, `status`, `list_order`, `app`, `controller`, `action`, `param`, `name`, `icon`, `remark`)
VALUES
...
/*!40000 ALTER TABLE `zdl_admin_menu` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table zdl_asset
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_asset`;

CREATE TABLE `zdl_asset` (
...
# Dump of table zdl_auth_access
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_auth_access`;

CREATE TABLE `zdl_auth_access` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
# Dump of table zdl_auth_rule
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_auth_rule`;

CREATE TABLE `zdl_auth_rule` (
...
LOCK TABLES `zdl_auth_rule` WRITE;
/*!40000 ALTER TABLE `zdl_auth_rule` DISABLE KEYS */;

INSERT INTO `zdl_auth_rule` (`id`, `status`, `app`, `type`, `name`, `param`, `title`, `condition`)
VALUES
...
/*!40000 ALTER TABLE `zdl_auth_rule` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table zdl_comment
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_comment`;

CREATE TABLE `zdl_comment` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
# Dump of table zdl_hook
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_hook`;

CREATE TABLE `zdl_hook` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `zdl_hook` WRITE;
/*!40000 ALTER TABLE `zdl_hook` DISABLE KEYS */;

INSERT INTO `zdl_hook` (`id`, `type`, `once`, `name`, `hook`, `app`, `description`)
VALUES
...
/*!40000 ALTER TABLE `zdl_hook` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table zdl_hook_plugin
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_hook_plugin`;

CREATE TABLE `zdl_hook_plugin` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `list_order` float NOT NULL DEFAULT '10000' COMMENT '排序',
...
# Dump of table zdl_link
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_link`;

CREATE TABLE `zdl_link` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `zdl_link` WRITE;
/*!40000 ALTER TABLE `zdl_link` DISABLE KEYS */;

INSERT INTO `zdl_link` (`id`, `status`, `rating`, `list_order`, `description`, `url`, `name`, `image`, `target`, `rel`)
VALUES
	(1,1,1,8,'thinkcmf官网','http://www.thinkcmf.com','ThinkCMF','','_blank','');

/*!40000 ALTER TABLE `zdl_link` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table zdl_nav
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_nav`;

CREATE TABLE `zdl_nav` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `zdl_nav` WRITE;
/*!40000 ALTER TABLE `zdl_nav` DISABLE KEYS */;

INSERT INTO `zdl_nav` (`id`, `is_main`, `name`, `remark`)
VALUES
	(1,1,'主导航','主导航'),
	(2,0,'底部导航','');

/*!40000 ALTER TABLE `zdl_nav` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table zdl_nav_menu
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_nav_menu`;

CREATE TABLE `zdl_nav_menu` (
...
LOCK TABLES `zdl_nav_menu` WRITE;
/*!40000 ALTER TABLE `zdl_nav_menu` DISABLE KEYS */;

INSERT INTO `zdl_nav_menu` (`id`, `nav_id`, `parent_id`, `status`, `list_order`, `name`, `target`, `href`, `icon`, `path`)
VALUES
	(1,1,0,1,0,'首页','','home','','0-1');

/*!40000 ALTER TABLE `zdl_nav_menu` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table zdl_option
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_option`;

CREATE TABLE `zdl_option` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `zdl_option` WRITE;
/*!40000 ALTER TABLE `zdl_option` DISABLE KEYS */;

INSERT INTO `zdl_option` (`id`, `autoload`, `option_name`, `option_value`)
VALUES
	(1,1,'site_info','{\"site_name\":\"\\u503c\\u5f97\\u9886\\u7ba1\\u7406\\u540e\\u53f0\",\"site_seo_title\":\"\\u503c\\u5f97\\u9886\\u7ba1\\u7406\\u540e\\u53f0\",\"site_seo_keywords\":\"\\u503c\\u5f97\\u9886\",\"site_seo_description\":\"\\u503c\\u5f97\\u9886\",\"site_icp\":\"\",\"site_gwa\":\"\",\"site_admin_email\":\"\",\"site_analytics\":\"\"}'),
...
/*!40000 ALTER TABLE `zdl_option` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table zdl_plugin
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_plugin`;

CREATE TABLE `zdl_plugin` (
...
# Dump of table zdl_portal_category
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_portal_category`;

CREATE TABLE `zdl_portal_category` (
...
LOCK TABLES `zdl_portal_category` WRITE;
/*!40000 ALTER TABLE `zdl_portal_category` DISABLE KEYS */;

INSERT INTO `zdl_portal_category` (`id`, `parent_id`, `post_count`, `status`, `delete_time`, `list_order`, `name`, `description`, `path`, `seo_title`, `seo_keywords`, `seo_description`, `list_tpl`, `one_tpl`, `more`)
VALUES
	(1,0,0,1,0,10000,'淘宝','淘宝优惠','0-1','','','','list','article','{\"thumbnail\":\"\"}'),
	(2,0,0,1,0,10000,'天猫','天猫优惠','0-2','','','','list','article','{\"thumbnail\":\"\"}'),
	(3,0,0,1,0,10000,'拼多多','拼多多优惠','0-3','','','','list','article','{\"thumbnail\":\"\"}'),
	(4,0,0,1,0,10000,'京东','京东优惠','0-4','','','','list','article','{\"thumbnail\":\"\"}'),
	(5,0,0,1,0,10000,'活动','活动','0-5','','','','list','article','{\"thumbnail\":\"\"}');

/*!40000 ALTER TABLE `zdl_portal_category` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table zdl_portal_category_post
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_portal_category_post`;

CREATE TABLE `zdl_portal_category_post` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
# Dump of table zdl_portal_post
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_portal_post`;

CREATE TABLE `zdl_portal_post` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
# Dump of table zdl_portal_tag
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_portal_tag`;

CREATE TABLE `zdl_portal_tag` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '分类id',
  `status` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '状态,1:发布,0:不发布',
  `recommended` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否推荐;1:推荐;0:不推荐',
...
# Dump of table zdl_portal_tag_post
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_portal_tag_post`;

CREATE TABLE `zdl_portal_tag_post` (
...
# Dump of table zdl_recycle_bin
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_recycle_bin`;

CREATE TABLE `zdl_recycle_bin` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
# Dump of table zdl_role
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_role`;

CREATE TABLE `zdl_role` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `zdl_role` WRITE;
/*!40000 ALTER TABLE `zdl_role` DISABLE KEYS */;

INSERT INTO `zdl_role` (`id`, `parent_id`, `status`, `create_time`, `update_time`, `list_order`, `name`, `remark`)
VALUES
	(1,0,1,1329633709,1329633709,0,'超级管理员','拥有网站最高管理员权限！'),
	(2,0,1,1329633709,1329633709,0,'普通管理员','权限由最高管理员分配！');

/*!40000 ALTER TABLE `zdl_role` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table zdl_role_user
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_role_user`;

CREATE TABLE `zdl_role_user` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
# Dump of table zdl_route
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_route`;

CREATE TABLE `zdl_route` (
...
LOCK TABLES `zdl_route` WRITE;
/*!40000 ALTER TABLE `zdl_route` DISABLE KEYS */;

INSERT INTO `zdl_route` (`id`, `list_order`, `status`, `type`, `full_url`, `url`)
VALUES
	(1,5000,1,2,'portal/List/index?id=1','taobao'),
	(2,4999,1,2,'portal/Article/index?cid=1','taobao/:id'),
	(3,5000,1,2,'portal/List/index?id=2','tianmao'),
	(4,4999,1,2,'portal/Article/index?cid=2','tianmao/:id'),
	(5,5000,1,2,'portal/List/index?id=3','pinduoduo'),
	(6,4999,1,2,'portal/Article/index?cid=3','pinduoduo/:id'),
	(7,5000,1,2,'portal/List/index?id=4','jingdong'),
	(8,4999,1,2,'portal/Article/index?cid=4','jingdong/:id'),
	(9,5000,1,2,'portal/List/index?id=5','huodong'),
	(10,4999,1,2,'portal/Article/index?cid=5','huodong/:id');

/*!40000 ALTER TABLE `zdl_route` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table zdl_slide
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_slide`;

CREATE TABLE `zdl_slide` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
# Dump of table zdl_slide_item
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_slide_item`;

CREATE TABLE `zdl_slide_item` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
# Dump of table zdl_theme
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_theme`;

CREATE TABLE `zdl_theme` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `zdl_theme` WRITE;
/*!40000 ALTER TABLE `zdl_theme` DISABLE KEYS */;

INSERT INTO `zdl_theme` (`id`, `create_time`, `update_time`, `status`, `is_compiled`, `theme`, `name`, `version`, `demo_url`, `thumbnail`, `author`, `author_url`, `lang`, `keywords`, `description`)
VALUES
...
/*!40000 ALTER TABLE `zdl_theme` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table zdl_theme_file
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_theme_file`;

CREATE TABLE `zdl_theme_file` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `zdl_theme_file` WRITE;
/*!40000 ALTER TABLE `zdl_theme_file` DISABLE KEYS */;

INSERT INTO `zdl_theme_file` (`id`, `is_public`, `list_order`, `theme`, `name`, `action`, `file`, `description`, `more`, `config_more`, `draft_more`)
VALUES
...
/*!40000 ALTER TABLE `zdl_theme_file` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table zdl_third_party_user
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_third_party_user`;

CREATE TABLE `zdl_third_party_user` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
# Dump of table zdl_user
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_user`;

CREATE TABLE `zdl_user` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `zdl_user` WRITE;
/*!40000 ALTER TABLE `zdl_user` DISABLE KEYS */;

INSERT INTO `zdl_user` (`id`, `user_type`, `sex`, `birthday`, `last_login_time`, `score`, `coin`, `balance`, `create_time`, `user_status`, `user_login`, `user_pass`, `user_nickname`, `user_email`, `user_url`, `avatar`, `signature`, `last_login_ip`, `user_activation_key`, `mobile`, `more`)
VALUES
	(1,1,0,0,1548930284,0,0,0.00,1548930259,1,'admin','###466e744ebb2719017be715a524842b97','admin','admin@zhideling.com','','','','0.0.0.0','','',NULL);

/*!40000 ALTER TABLE `zdl_user` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table zdl_user_action
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_user_action`;

CREATE TABLE `zdl_user_action` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `zdl_user_action` WRITE;
/*!40000 ALTER TABLE `zdl_user_action` DISABLE KEYS */;

INSERT INTO `zdl_user_action` (`id`, `score`, `coin`, `reward_number`, `cycle_type`, `cycle_time`, `name`, `action`, `app`, `url`)
VALUES
	(1,1,1,1,2,1,'用户登录','login','user','');

/*!40000 ALTER TABLE `zdl_user_action` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table zdl_user_action_log
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_user_action_log`;

CREATE TABLE `zdl_user_action_log` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '用户id',
...
# Dump of table zdl_user_balance_log
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_user_balance_log`;

CREATE TABLE `zdl_user_balance_log` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
# Dump of table zdl_user_favorite
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_user_favorite`;

CREATE TABLE `zdl_user_favorite` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
# Dump of table zdl_user_like
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_user_like`;

CREATE TABLE `zdl_user_like` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '用户 id',
...
# Dump of table zdl_user_login_attempt
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_user_login_attempt`;

CREATE TABLE `zdl_user_login_attempt` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
# Dump of table zdl_user_score_log
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_user_score_log`;

CREATE TABLE `zdl_user_score_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) NOT NULL DEFAULT '0' COMMENT '用户 id',
...
# Dump of table zdl_user_token
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_user_token`;

CREATE TABLE `zdl_user_token` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `zdl_user_token` WRITE;
/*!40000 ALTER TABLE `zdl_user_token` DISABLE KEYS */;

INSERT INTO `zdl_user_token` (`id`, `user_id`, `expire_time`, `create_time`, `token`, `device_type`)
VALUES
	(1,1,1564482284,1548930284,'97f9f9f23f170172f56fce1ff4f3dd60af9241c75c526d3ad5773836f605df1b','web');

/*!40000 ALTER TABLE `zdl_user_token` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table zdl_verification_code
# ------------------------------------------------------------

DROP TABLE IF EXISTS `zdl_verification_code`;

CREATE TABLE `zdl_verification_code` (
